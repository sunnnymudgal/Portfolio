...
function TechLogo(props) {
  ...
  return (
    <>
      <div
        className={`${bg}  text-2xl lg:text-4xl lg:px-5 lg:py-3 lg:m-1 text-white m-[2px] flex items-center w-fit px-3 py-1 gap-2 uppercase anton-sc-regular tracking-[1px] cursor-pointer`}
      >
...
function Skills() {
  return (
    <div id="skills">
      <div className="px-[10vw] bg-[#EDF2FC] py-5">
        <h1 className="lg:py-5 py-4 roboto-bold lg:text-5xl text-4xl lg:my-3 text-[#474849]">
          SKILLS;
        </h1>
