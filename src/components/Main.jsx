    ...
    <>
      ...
      >
        <div className="p1 bg-[#EDF2FC] h-fit w-[70%] max-lg:w-[100%] flex flex-col lg:gap-[3vh] sm:gap-[2vh] gap-[1vh] mt-[10vh] pb-10 pl-[5vw]  max-md:px-2vh">
          ...
          <div className=" hover:scale-90 transform duration-200 ease-out c3 cursor-pointer flex items-center justify-center lg:text-xl md:text-lg sm:text-sm text-xs font-mono tracking-widest bg-[#9c7301] w-fit py-1 px-3 rounded-md text-[#EDF2FC] mt-10">
            DOWNLOAD RESUME
          </div>
        </div>
        <Footer />
